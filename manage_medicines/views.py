...
def medicine_manage(request):
    if request.method == 'POST':
            ...
            obj = Medicine.objects.create(med_name = med_name, price=price,selling_price=selling_price,supplier=supplier,bought_date=bought_date,expiry_date=expiry_date,time_table=time_table)
            if obj:
